...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final      StatementContext ctx) throws SQLException {
     ...
     * @return Employee
     */
    return new Employee(rs.getInt("EMP_ID"), rs.getString("EMP_NAME"), rs.getString("EMP_EMAILID"),
    rs.getLong("EMP_MOBNO"), rs.getDate("EMP_DOJ"), rs.getString("EMP_DEPT"), rs.getInt("EMP_MGRID"),
    rs.getInt("EMP_LEAVEBALANCE"));
  }
}
